package com.sky.crawling.component.zhihu;

import com.sky.crawling.dao.CrawlerDao;
import com.sky.crawling.entity.CmsContentPO;
...
public class ZhihuPipeline implements Pipeline {
	...
	public void process(ResultItems resultItems, Task task) {
		...
		try {
			boolean success = crawlerDao.addCmsContent(contentPO) > 0;
